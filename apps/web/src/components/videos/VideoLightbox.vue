...
<script setup lang="ts">
    ...
    import BaseLightbox from '@/components/shared/BaseLightbox.vue';

    import type { LightboxVideo, VideoLightboxEmits, VideoLightboxProps } from './types';

    defineProps<VideoLightboxProps>();

    const emit = defineEmits<VideoLightboxEmits>();
